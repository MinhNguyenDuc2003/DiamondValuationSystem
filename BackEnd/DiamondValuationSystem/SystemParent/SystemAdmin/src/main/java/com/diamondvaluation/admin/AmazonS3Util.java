...
public class AmazonS3Util {
	...
	public static void uploadFile(String folderName, String fileName, InputStream inputStream) throws S3Exception, AwsServiceException, SdkClientException, java.io.IOException {
		S3Client client = S3Client.builder().build();
