...
import com.diamondvaluation.shop.MyWebSocketHandler;
...
public class PaymentController {
	...
	public ResponseEntity<?> placeOrder(@RequestBody @Valid CheckOutRequest checkOutRequest,
		...
		try {
			...
			webSocketHandler.sendMessageToAll("Data saved: ");
...
//	}
	...
	public ResponseEntity<?> pay(HttpServletRequest request, @RequestParam("total") double total) {
		try {
			Payment payment = paypalService.createPayment(total, "USD", PaypalPaymentMethod.paypal,
					PaypalPaymentIntent.sale, "payment description", BASEURL + "pay/cancel", BASEURL + "pay/success");
	...
	public ResponseEntity<?> successPay(@RequestParam("paymentId") String paymentId,
			@RequestParam("PayerID") String payerId, @RequestBody @Valid CheckOutRequest checkOutRequest,
