        ...
        <div className='wrapperrr'>         
            ...
            <div className='body-valuation'>
                {dataContent.ValuationIntroduction.sections.map((section, index) => {
                    switch (section.type) {
                        case 'paragraph':
                            return <div className='paragraph' key={index}><p>{section.content}</p></div>;
                        case 'img':
                            return <img className='img-valuation' key={index} src={section.src === 'pic1' ? pic1 : ""} alt={section.alt} />;
                        default:
                            return null;
                    }
                })}
