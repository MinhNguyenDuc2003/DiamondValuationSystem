...
import { getRoles, saveUser } from '../utils/ApiFunctions'
...
const handleSubmit = async (e) => {
  ...
  return (
    <div className='container-fluid'>
      <div><h2 className='text-center'>Manage Users</h2></div>

	  

      <form onSubmit={(e) => handleSubmit(e)} style={{maxWidth: "700px", margin: "0 auto"}}>
        ...
        <div className="form-group row mt-3">
				...
				<div className="form-group row mt-2">
					...
					<div className="col-sm-8">
							...
							<br/>
							{imagePreview && (
									<img src={imagePreview} id="thumbnail" alt="Photos preview"
									className="img-fluid mt-3" style={{ maxWidth: "400px", maxHeight: "400px" }}/>
								)}
				...
				<div className="text-center">
					<input type="submit" value="Save" className="btn btn-primary m-3" />
					 <input
						type="button" value="Cancel" className="btn btn-secondary"
						id="buttonCancel"/>
				</div>
